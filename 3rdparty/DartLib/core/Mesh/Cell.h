...
/*===================================================================
                    Class i-cells for 4-manifold
===================================================================*/

class CVertex_4 : public TCell<0, 4>
{
  public:
    void to_string(){};
    void from_string(){};
...
class CEdge_4 : public TCell<1, 4>
{
  public:
    void to_string(){};
    void from_string(){};
...
class CFace_4 : public TCell<2, 4>
{
  public:
    void to_string(){};
    void from_string(){};
...
class CVolume_4 : public TCell<3, 4>
{
  public:
    void to_string(){};
    void from_string(){};
...
class CCell_4 : public TCell<4, 4>
{
  public:
    void to_string(){};
    void from_string(){};
