...
class CPoint2
{
  public:
    ...
    bool operator==(const CPoint2& uv) { return (m_c[0] == uv.m_c[0] && m_c[1] == uv.m_c[1]); }
 ...
 */
inline double mag2(CPoint2& uv) { return uv[0] * uv[0] + uv[1] * uv[1]; };
 ...
 */
inline double mag(CPoint2& uv) { return sqrt(uv[0] * uv[0] + uv[1] * uv[1]); };
...
inline double cross(CPoint2 uv1, CPoint2 uv2) { return (uv1[0] * uv2[1] - uv1[1] * uv2[0]); };
 ...
 */
inline double operator*(CPoint2 a, CPoint2 b) { return a[0] * b[0] + a[1] * b[1]; }
...
inline double operator^(CPoint2 uv1, CPoint2 uv2) { return (uv1[0] * uv2[1] - uv1[1] * uv2[0]); };
