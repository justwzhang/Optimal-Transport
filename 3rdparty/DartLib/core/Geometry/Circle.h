...
#ifndef _DARTLIB_CIRCLE_H_
#define _DARTLIB_CIRCLE_H_
...
class CCircle
{
  ...
  protected:
    ...
    {
        double d = x[0][0] * x[1][1] * x[2][2] + x[0][2] * x[1][0] * x[2][1] + x[0][1] * x[1][2] * x[2][0] - x[2][0] * x[1][1] * x[0][2] -
